...
//recuperar os dados do aluno escolhido no index_Curso.php
if(isset($_GET["codigo"])) {
    $dadosCurso = $Curso->listarID($_GET["codigo"]);
            ...
            <form action="alterar_curso.php?codigo=<?php echo $dadosCurso->codigo; ?>" method="post">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="number" name="serie" class="form-control" value="<?php echo $dadosCurso->serie; ?>">
                        </div>
                    <div align="center">
