...
//instaciar a classe Disciplina
$Disciplina = new Disciplina();

//recuperar os dados do aluno escolhido no index_Disciplina.php
if(isset($_GET["numero"])) {
    $dadosDisciplina = $Disciplina->listarID($_GET["numero"]);
        ...
        <div class="col-lg-12">
            <form action="alterar_disciplina.php?numero=<?php echo $dadosDisciplina->numero; ?>" method="post">
                    ...
                    <div align="center">
                        ...
                        <a class="btn btn-outline-danger" href="index_disciplina.php">Cancelar</a>
                    </div>
            </form>
        </div>
    </div>
